...
TP = np.sum(new_classifier.predict(test_set) * test_answers)
TN = np.sum((1 - new_classifier.predict(test_set)) * (1 -test_answers))
FP = np.sum(new_classifier.predict(test_set) * (1- test_answers))
FN = np.sum((1 - new_classifier.predict(test_set)) * test_answers)
